...
**Возможное решение:**
В ходе экспериментов было обнаружено, что использование единых (сквозных) RT для L3VNI во всех подах (RT 65500:200101 и 65500:200102) позволяет установить полноценную симметричную IRB и между подами. В этом случае:
