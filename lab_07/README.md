...
|        | vlan100   | `172.16.100.5`      | `fd:1:100::5/64`      |
|        | vlan200   | `172.16.200.5`      | `fd:1:200::5/64`      |
...
Базовая настройка **Underlay** и **Overlay** сети была произведена в лаботаторных работах № 4 - 6.
...
<summary>Информация MLAG</summary>

### L01

!["L01 MLAG"](./img/L01_mlag.png)
...
### Обмен маршрутной информации NLRI ESI
